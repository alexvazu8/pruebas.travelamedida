...
class ReservasController extends Controller
{
   ...
   {   //colocar el modelo Reserva
       ...
       if (!$response->successful()) {
           ...
           // Limpiar cach¨¦ relacionada con el token anterior
           ...
           //dd($data);
            // Acceder a los valores espec¨ªficos
            ...
            //  Genera un GUID ¨²nico de 36 chars, esto lo estoy colocando como prueba porque debe llegar como parametro.
   ...
   {   //colocar el modelo Reserva
       ...
       if (!$response->successful()) {
           ...
           // print_r($data);
            ...
            // Procesar la relaciÃ³n detalle_reservas
